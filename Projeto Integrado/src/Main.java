...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * println("digite o codResponsavel que quer apagar. Ou digite 0 para sair");
		 * int decisaoUser = scanner.nextInt(); if (decisaoUser != 0) {
		 * removerResponsavel(decisaoUser); } Scanner scanner2 = new Scanner(System.in);
		 * System.out.
		 * println("digite o codResponsavel que quer alterar. Ou digite 0 para sair");
		 * decisaoUser = scanner2.nextInt(); if (decisaoUser != 0) { Scanner scanner3 =
		 * new Scanner(System.in); System.out.println("digite o novo nome"); String
		 * novoNome = scanner3.next(); alterarResponsavel(decisaoUser, novoNome); }
		 * 
		 * Scanner scanner4 = new Scanner(System.in); System.out.
		 * println("digite o codResponsavel que quer alterar. Ou digite 0 para sair");
		 * decisaoUser = scanner4.nextInt(); if (decisaoUser != 0) {
	...
	protected static void executarAluno() {
		...
		Aluno aluno = new Aluno("João da Silva", "45638378", 1, "3", "01/01/1990", 1, 0);
	...
	protected static void executarRegistro() {
		...
		Registro registro = new Registro("entrada", "01/01/2000", "23:00:00", 2, 2, 2);
		RegistroController controller = new RegistroController(); // criar objeto
		controller.persistir(registro);// executar método do controller
	}

	protected static void consultarRegistro(int codAluno) {
